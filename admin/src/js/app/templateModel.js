...
define(['./util/util'], function(Util) {
    ...
    TemplateModel.prototype.load = function(data) {
        ...
        Util.each(this.$, data.data, function(_, item) {
        ...
        idIndex = _initIndex(this.$, 'id', model);
    };
    ...
    TemplateModel.prototype.deleteEntry = function(id) {
        ...
        var self = this;
        Util.recursiveWalk(self.$, model, function(_, currModel) {
            if (hasDeleted) {
                return false;
            }

            Util.each(self.$, currModel, function(childModelIndex, childModel) {
                if (hasDeleted) {
                    return false;
                }
